      ...
      <section className="hero">
        <div>
          ...
          <p>
            ...
            Live PrizePicks feed is not wired in this recovery build — use PrizePicks dashboard for market data.
          </p>
        </div>
        ...
        <div className="stack">
          ...
          <div className="card">
            ...
            <ul className="checkList">
              ...
              <li>PrizePicks surface uses dedicated <code>prizepicks.ts</code> service</li>
            </ul>
          </div>
        </div>
      </section>
