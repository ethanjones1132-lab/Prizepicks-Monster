# Backtest Report — PrizePicks Monster — market entry-price calibration + CLV (resolved markets)

## Caveats

- ⚠️ Data: 1008 settled PrizePicks markets across series ["KXHIGHNY", "KXHIGHCHI", "KXHIGHAUS", "KXHIGHDEN", "KXHIGHLAX", "KXHIGHMIA", "KXFED", "KXCPIYOY", "KXPAYROLLS", "KXBTCD", "KXETHD"] (public API, volume >= 500, lifetime >= 6h), cached in eval-data/.
